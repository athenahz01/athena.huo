...
export default function Home() {
 ...
 <div className="portrait-stage"><img className="portrait portrait-base" src="/images/add-color.jpg" alt="Athena Huo in New York" width="1179" height="1942" fetchPriority="high"/><img className="portrait portrait-color" src="/images/add-color.jpg" alt="" width="1179" height="1942" aria-hidden="true"/><span className="portrait-label label-build">SYSTEMS THINKER</span><span className="portrait-label label-story">STORYTELLER</span><span className="and-mark" aria-hidden="true">&</span><div className="portrait-caption"><span>ONE PERSON. BOTH SIDES.</span><ArrowUpRight size={21}/></div></div>
